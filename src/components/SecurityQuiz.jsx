...
const ALL_QUESTIONS = [
  ...
  },
  {
    ...
    options: ['Wait and monitor', 'Report it within 24 hours', 'Tell a colleague first', 'Try to fix it yourself'],
    correct: 1,
  ...
  },
  {
    ...
    options: ['BlueSky@2024#Secure', 'password123', 'MyDog!RunsFast42', 'Tr@nsf0rm@t1on'],
    correct: 1,
  ...
  },
  {
    ...
    options: ['Multi-Factor Authentication', 'Maximum File Access', 'Most Frequently Accessed', 'Multi-Flag Authorization'],
    correct: 0,
  ...
  },
  {
    ...
    options: ['Via email', 'Via encrypted channels (TLS 1.2+)', 'Via instant messaging', 'Via plain HTTP'],
    correct: 1,
  ...
  },
  {
    ...
    options: ['Annually', 'Quarterly', 'Bi-annually (twice yearly)', 'Monthly'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['Nothing', 'Warning message', 'Account is locked', 'Email is sent'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['Increase company profits', 'Protect information assets through risk management', 'Improve website performance', 'Reduce employee workload'],
    correct: 1,
  ...
  },
  {
    ...
    options: ['Public advertisements', 'Company logo', 'Employee salary records', 'Published press releases'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['Open it immediately', 'Forward it to colleagues', 'Verify the sender and scan for threats', 'Delete all emails'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['A software update process', 'An attempt to trick users into revealing sensitive information', 'A data backup method', 'A type of firewall'],
    correct: 1,
  ...
  },
  {
    ...
    options: ['Sharing passwords with coworkers', 'Leaving your computer unlocked', 'Locking your screen when away', 'Writing passwords on sticky notes'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['To increase internet speed', 'To recover data in case of loss or damage', 'To improve password strength', 'To monitor employee activities'],
    correct: 1,
  ...
  },
  {
    ...
    options: ['Installing antivirus software', 'Updating operating systems', 'Impersonating IT support to obtain passwords', 'Encrypting files'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['It changes the user interface', 'It removes unnecessary files', 'It fixes security vulnerabilities and bugs', 'It increases storage capacity'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['Click the links to investigate', 'Reply asking for more details', 'Report it to the IT/Security team', 'Forward it to everyone'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['Using the same password for all accounts', 'Sharing passwords with trusted coworkers', 'Using unique passwords for different accounts', 'Storing passwords in a public document'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['To increase internet bandwidth', 'To restrict access to authorized users only', 'To monitor printer usage', 'To reduce hardware costs'],
    correct: 1,
...
export default function SecurityQuiz({ onScoreUpdate }) {
  ...
  const handleAnswerClick = (index) => {
    if (!answered) {
      ...
      setAnswered(true)
      setAnswers([...answers, { questionId: questions[currentQuestion].id, userAnswer: index, correct: isCorrect }])
    ...
    return (
      <div className="security-quiz">
        ...
        <div className="quiz-setup-card">
          ...
          <p className="setup-sub">Questions are randomly selected and shuffled every time.</p>
          <div className="count-options">
            {COUNT_OPTIONS.map(n => (
              <button key={n} className="count-btn" onClick={() => startQuiz(n)}>
                {n} Questions
              </button>
            ))}
          </div>
      ...
      <div className="quiz-results">
        <div className="results-card">
          ...
          <div className="results-actions">
            <button className="btn-restart" onClick={() => startQuiz(quizCount)}>
              Retake ({quizCount} questions)
            </button>
            <button className="btn-change-count" onClick={handleRestart}>
  ...
  const hasStarted = currentQuestion > 0 || answered
